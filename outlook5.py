...
def mail_adjuntos(mail_carpeta: str,
                  ...
                  archivo_rutas: dict[str, Path] = None,
        ...
        if condicion_mail:
            ...
            for attachment in msg.Attachments:
                ...
                if ((nombre_archivo.suffix.lower() in extensiones_permitidas) and
                    ...
                    nombre_clave = None
                    for clave, ruta_destino in archivo_rutas.items():
                        if clave.lower() in nombre_archivo.stem.lower():
                            destino_especifico = ruta_destino
                            nombre_clave = clave
                            break
                    ...
                    if destino_especifico:
                        ...
                        if nombre_archivo.suffix.lower() == '.xls' and convertir_xls:
                            try:
                                ...
                                nuevo_nombre = f'{nombre_clave}.xlsx'
                                ruta_final = destino_especifico / nuevo_nombre
                            ...
                            ruta_final = destino_especifico / nombre_archivo.name
...
# EJEMPLO DE USO
archivo_rutas = {
    'stock_diario': Path(r'C:\RUTA\STOCK'),
    'informe_ventas': Path(r'C:\RUTA\VENTAS')
}
